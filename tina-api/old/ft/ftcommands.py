...
from ft.api.models.apimodels import prediction, training, getstate, loadmodel
...
ftcommands = api.namespace('/ft/', description='Api for Fasttext')

@ftcommands.route('/schema')
