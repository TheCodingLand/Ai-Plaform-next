...
class RunTrainingCard extends React.Component {
  ...
  handleChangeSlider = name => (event, value) => {
    ...
    newmodel.model.model.name = `${this.state.dataset.dataset.classifier}_${
      newmodel.model.model.epochs
    }_${newmodel.model.learningRate.toFixed(1)}_${newmodel.model.ngrams}`;
